...
#define CONFIG_SYS_TEXT_BASE		0x3001000
#endif
...
#define CONFIG_SYS_NAND_BASE_PHYS	0xffa00000
#else
...
#ifdef CONFIG_RAMBOOT
#define CONFIG_SYS_INIT_RAM_ADDR	0x07000000 /* stack in RAM */
#else
...
#if (defined(CONFIG_NAND) || defined(CONFIG_RAMBOOT))
